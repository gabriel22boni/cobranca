...
@section('title', 'Cadastros - M. Admin')
...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Administrador Master</li>
    </ol>
@stop

@section('content')
    <div class="card card-info" style="position: relative; left: 0px; top: 0px;">
        <div class="card-header border-0 ui-sortable-handle" style="cursor: move;">
            <h3 class="card-title">
                <i class="fas fa-th mr-1"></i>
                M. Administradores Cadastrados
            </h3>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-sm-5 float-left">
                        <form action="{{ route('cadastros.masterAdmin.search') }}" method="POST" class="form form-inline">
                            {!! csrf_field() !!}
                    ...
                    <div class="card-tools float-right">
                        @if(isset($dataForm))
                            {!! $cadAdmasters->appends($dataForm ?? '')->links() !!} 
                        @else
                            {!! $cadAdmasters->links() !!}     
                        @endif
                    </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach($cadAdmasters as $cadAdmaster)
                                <tr id="clienteRow{{$cadAdmaster->id}}">
                                    <td>{{$cadAdmaster->id}}.</td>
                                    <td>{{$cadAdmaster->nome ?? $cadAdmaster->fnome}}</td>
                                    <td>
                                        <center>
                                            <button onclick="modalDados({{$cadAdmaster->id}})" type="button" class="btn btn-primary" style="width:100px;">
                                                Ver
                                            </button>
                                        </center>
                                    </td>
                                    <td>
                                        <center>
                                            <button onclick="modalEditar({{$cadAdmaster->id}})" type="button" class="btn btn-secondary" style="width:100px;">
                                                Editar
                                            </button>
                                        </center>
                                    </td>
                                    <td>
                                        <center>
                                            <button onclick="modalDel({{$cadAdmaster->id}},'confirm')" type="button" class="btn btn-danger" style="width:100px;">
                                                Excluir
                                            </button>
                                        </center>
                                    </td>
        ...
        <div class="card-body" style="display: block;">
            ...
            <input type="text" class="form-control formData" id="image" name="image" style="display:none">
                <div class="row">
                    ...
                    <input style="display:none" type="text" class="form-control formData" id="idceo" name="idceo" value="{{auth()->user()->idceo}}">
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <center><p>Master Administrador Cadastrado com sucesso.</p></center>
                </div>
                            ...
                            <div class="col-sm-12 col-md-10 col-lg-10"><!-- Coluna direita -->
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        <label for="idceoVer">CEO</label>
                                        <select class="form-control" disabled="">
                                            <option name="idceoVer" class="formDataVer" id="idceoVer">CEO Nome</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-sm-8">
                                    </div>
                                </div>
                                <div class="row" style="display:none" id="pessoaJVer">
                                    <div class="form-group col-sm-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row" style:="display:none">
                                        <div class="form-group col-sm-4" style="display:none;">
                                                <label for="idceoEdit">CEO</label>
                                                <select name="idceoEditSelect" id="idceoEditSelect" class="form-control formDataEditSelect">
                                                    <option name="idceoEdit" class="formDataEdit" id="idceoEdit" value="">CEO Nome</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-sm-12">
                                            </div>
                                    </div>
                                    <div class="row" style="display:none" id="pessoaJEdit">
                                        <div class="form-group col-sm-5">
...
@section('js')
    ...
    <script>
        ...
        function formSubmit (){
            ...
            idceo = document.getElementsByClassName('formData').idceo.value;        
            
            $.ajax({
                type: "POST",
                url: "{{ route('cadastros.masterAdmin.insert') }}",
                data: {
                    _token:'{{csrf_token()}}',
                    bairro,
                    cidade,
        ...
        function pageRefresh(){
            window.location.href = "{{route('cadastros.masterAdmin')}}";
        }

        function modalDados(id){
            $.ajax({
                url:"{{ route('cadastros.masterAdmin.dados') }}",
                type:"post",
                datatype:"json",
                data:{
                    _token:"{{csrf_token()}}",
                ...
                success:function(retorno){
                    ...
                    if(retorno[0].fnomeceo == null){
                        document.getElementsByClassName('formDataVer').idceoVer.innerHTML = retorno[0].nomeceo;         
                    }else{
                        document.getElementsByClassName('formDataVer').idceoVer.innerHTML = retorno[0].fnomeceo;         
                    }
        ...
        function modalEditar(id){
            ...
            $.ajax({
                ...
                success:function(retorno){
                    ...
                    if(retorno[0].fnomeceo == null){
                        elementos.idceoEdit.innerHTML = retorno[0].nomeceo;         
                    }else{
                        elementos.idceoEdit.innerHTML = retorno[0].fnomeceo;         
                    }
                    if(retorno[0].pessoa == 'F'){
        ...
        function ModalConfAlter(){
            ...
            idceo = document.getElementsByClassName('formDataEditSelect').idceoEditSelect.value, 
