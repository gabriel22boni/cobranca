                        ...
                        <tbody>
                            @foreach($cadAdms as $cadAdm)
                                <tr id="clienteRow{{$cadAdm->id}}">
                                    <td>{{$cadAdm->id}}.</td>
                                    <td>{{$cadAdm->nome ?? $cadAdm->fnome}}</td>
                                    <td>
                                        <center>
            ...
            <input type="text" class="form-control formData" id="image" name="image" style="display:none">
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        <label for="idmaster">Nome da Loja:</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">izebanc.com.br/loja/</span>
                            </div>
                            <input type="text" class="form-control formData" id="nomeLoja" name="nomeLoja">
                        </div>
                    </div>
                    <div class="form-group col-sm-4">
                        <label for="idmaster">M. Administrador</label>
                    ...
                    <form action="" method="POST" id="formCadastro" >
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-10 col-lg-10"><!-- Coluna direita -->
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        <label for="idmasterVer">M. Administrador</label>
                                        <select class="form-control" disabled="">
                                            <option name="idmasterVer" class="formDataVer" id="idmasterVer">M. Administrador Nome</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-sm-3">
                                    </div>
                                    <div class="form-group col-sm-5">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control formDataVer" id="nomeLojaVer" name="nomeLojaVer" disabled="true">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        @if(
                                            ...
                                            <div class="form-group col-sm-4">
                                                <label for="idmasterEdit">M. Administrador</label>
                                                <select name="idmasterEditSelect" id="idmasterEditSelect" class="form-control formDataEditSelect">
                                                    <option name="idmasterEdit" class="formDataEdit" id="idmasterEdit" value="">M. Administrador Nome</option>
                                                    @foreach($cadAdmasters as $cadAdmaster)
                                                        <option value="{{$cadAdmaster->id}}">{{$cadAdmaster->nome ?? $cadAdmaster->fnome}}</option>
                                                    @endforeach                       
                                                </select>
                                            ...
                                            <div class="form-group col-sm-5">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control formDataEdit" id="nomeLojaEdit" name="nomeLojaEdit">
                                                </div>
                                            </div>
                                        @else
...
@section('js')
    ...
    <script>
        ...
        function formSubmit (){
            ...
            nomeloja = document.getElementsByClassName('formData').nomeLoja.value;   
        ...
        function modalDados(id){
            $.ajax({
                ...
                success:function(retorno){
                    ...
                    document.getElementsByClassName('formDataVer').nomeLojaVer.value        = retorno[0].nomeloja;  
        ...
        function modalEditar(id){
            ...
            $.ajax({
                ...
                success:function(retorno){
                    ...
                    elementos.nomeLojaEdit.placeholder        = retorno[0].nomeloja;   
        ...
        function ModalConfAlter(){
            ...
            nomeloja = document.getElementsByClassName('formDataEdit').nomeLojaEdit.value; 
