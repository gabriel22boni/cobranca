...
@section('title', 'Cadastros - Cliente')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-sm-5 float-left">
                        <form action="{{ route('cadastros.cliente.search') }}" method="POST" class="form form-inline">
                            {!! csrf_field() !!}
                        ...
                        <tbody>
                            @foreach($cadClis as $cadCli)
                                <tr id="clienteRow{{$cadCli->id}}">
                                    ...
                                    <td>
                                        <center>
                                            <button onclick="modalDados({{$cadCli->id}})" type="button" class="btn btn-primary" style="width:100px;">
                                                Ver
                                            </button>
                                        </center>
                                    </td>
                                    <td>
                                        <center>
                                            <button onclick="modalEditar({{$cadCli->id}})" type="button" class="btn btn-secondary" style="width:100px;">
                                                Editar
                                            </button>
                                        </center>
                                    </td>
                                    <td>
                                        <center>
                                            <button onclick="modalDel({{$cadCli->id}},'confirm')" type="button" class="btn btn-danger" style="width:100px;">
                                                Excluir
                                            </button>
                                        </center>
                                    </td>
            ...
            <form action="" method="POST" id="formCadastro" >
                <div class="row">
                    <div class="form-group col-sm-2">
                        ...
                        <div id="tipopessoa" class="row">
                            <div class="form-check col-sm-6">
                                <input id="fisica" class="form-check-input formDataRadio" type="radio" name="pessoa" value="F" checked="true" onclick="pessoaAlter(this.value)">
                                <label class="form-check-label" onclick="pessoaAlter('F')">Física</label>
                            </div>
                            <div class="form-check col-sm-6">
                                <input id="juridica" class="form-check-input formDataRadio" type="radio" name="pessoa" value="J" onclick="pessoaAlter(this.value)">
                                <label class="form-check-label" onclick="pessoaAlter('J')">Jurídica</label>
                            </div>
                        </div>
                    </div>
                    @if(
                    ...
                    <div class="form-group col-sm-4">
                        <label for="idcob">Cobrador</label>
                        <select name="idcob" class="form-control formData" id="idcob">
                            <option value="">-- Cobrador --</option>
                            @foreach($cadCobs as $cadCob)
                                <option value="{{$cadCob->id}}">{{$cadCob->nome ?? $cadCob->fnome}}</option>
                            @endforeach
                        </select>
                    </div>
                    @else
                        <div class="form-group col-sm-8">
                            <input style="display:none" type="text" class="form-control formData" id="idcob" name="idcob" value="{{auth()->user()->idcob}}">
                        </div>
                    @endif
                    <div class="form-group col-sm-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control formData" id="limite" name="limite">
                        </div>
                    </div>
                </div>
                <div class="row" style="display:none" id="pessoaJ">
                    <div class="form-group col-sm-5">
                        <label for="fnome">Nome Fantasia</label>
                        <input type="text" class="form-control formData" id="fnome" name="fnome" placeholder="Nome Fantasia">
                    </div>
                    <div class="form-group col-sm-5">
                        <label for="razsoc">Razão Social</label>
                        <input type="text" class="form-control formData" id="razsoc" name="razsoc" placeholder="Razão Social">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="cnpj">CNPJ</label>
                        <input type="text" class="form-control formData" id="cnpj" name="cnpj" placeholder="10.011.001/0001-01">
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <center><p>Cliente Cadastrado com sucesso.</p></center>
                </div>
                    ...
                    <form action="" method="POST" id="formCadastro" >
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-10 col-lg-10"><!-- Coluna direita -->
                                <div class="row"><!-- linha 1 (cobrador, limite)-->
                                    <div class="form-group col-sm-4">
                                        <label for="idcobVer">Cobrador</label>
                                        <select class="form-control" disabled="">
                                            <option name="idcobVer" class="formDataVer" id="idcobVer">Cobrador Nome</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-sm-6">
                                    </div>
                                    <div class="form-group col-sm-2">
                                        <label for="limiteVer">Limite</label>
                                        <input type="text" class="form-control formDataVer" id="limiteVer" name="limiteVer" placeholder="R$" disabled="">
                                    </div>
                                </div>
                                <div class="row" style="display:none" id="pessoaJVer"><!-- linha 2 se PJ (Fnome, Raz.Soc e CNPJ) -->
                                    <div class="form-group col-sm-5">
                                        <label for="fnomeVer">Nome Fantasia</label>
                                        <input type="text" class="form-control formDataVer" id="fnomeVer" name="fnomeVer" placeholder="Nome Fantasia" disabled="">
                                    </div>
                                    <div class="form-group col-sm-5">
                                        <label for="razsocVer">Razão Social</label>
                                        <input type="text" class="form-control formDataVer" id="razsocVer" name="razsocVer" placeholder="Razão Social" disabled="">
                                    </div>
                                    <div class="form-group col-sm-2">
                                        <label for="cnpjVer">CNPJ</label>
                                        <input type="text" class="form-control formDataVer" id="cnpjVer" name="cnpjVer" placeholder="10.011.001/0001-01" disabled="">
                                    </div>
                                </div>
                                <div class="row" style="display:none" id="pessoaFVer"><!-- linha 2 se PF (Nome e CPF))-->
                                    <div class="form-group col-sm-10">
                                ...
                                <div class="row"><!-- linha 3 Endereço -->
                                    <div class="form-group col-sm-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row"><!--1--> 
                                        @if(
                                            ...
                                            <div class="form-group col-sm-4">
                                                <label for="idcobEdit">Cobrador</label>
                                                <select name="idcobEditSelect" id="idcobEditSelect" class="form-control formDataEditSelect">
                                                    <option name="idcobEdit" class="formDataEdit" id="idcobEdit" value="">Cobrador Nome</option>
                                                    @foreach($cadCobs as $cadCob)
                                                        <option value="{{$cadCob->id}}">{{$cadCob->nome ?? $cadCob->fnome}}</option>
                                                    @endforeach                       
                                                </select>
                                        ...
                                        @endif
                                        <div class="form-group col-sm-2">
                                            <label for="limiteEdit">Limite</label>
                                            <input type="text" class="form-control formDataEdit" id="limiteEdit" name="limiteEdit" placeholder="R$">
                                        </div>
                                    </div>
                                    <div class="row" style="display:none" id="pessoaJEdit"><!--2-->
                                        <div class="form-group col-sm-5">
                                            <label for="fnomeEdit">Nome Fantasia</label>
                                            <input type="text" class="form-control formDataEdit" id="fnomeEdit" name="fnomeEdit" placeholder="Nome Fantasia">
                                        </div>
                                        <div class="form-group col-sm-5">
                                            <label for="razsocEdit">Razão Social</label>
                                            <input type="text" class="form-control formDataEdit" id="razsocEdit" name="razsocEdit" placeholder="Razão Social">
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label for="cnpjEdit">CNPJ</label>
                                            <input type="text" class="form-control formDataEdit" id="cnpjEdit" name="cnpjEdit" placeholder="10.011.001/0001-01">
                                        </div>
                                    </div>
                                    <div class="row" style="display:none" id="pessoaFEdit"><!--2-->
                                        <div class="form-group col-sm-10">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="dadosModalDelPJ">
                        <strong>id: </strong> <span id="idJDel" class="dadosModalDel"></span></br>
                        <strong>Nome Fantasia: </strong> <span id="nomeFantasiaDel" class="dadosModalDel"></span></br>
                        <strong>Razão Social:</strong> <span id="razSocDel" class="dadosModalDel"></span></br>
                        <strong>CNPJ:</strong> <span id="cnpjDel" class="dadosModalDel"></span>
                    </div>
                </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#limite").mask("9999999999.00",{reverse:true});
            ...
            $("#limiteEdit").mask("9999999999.00",{reverse:true});
            $("#cnpjEdit").mask("00.000.000/0001-00");
        ...
        function formSubmit (){
            var bairro = document.getElementsByClassName('formData').bairro.value,
            cidade = document.getElementsByClassName('formData').cidade.value,
            cnpj = document.getElementsByClassName('formData').cnpj.value,
            ...
            fnome = document.getElementsByClassName('formData').fnome.value,
            limite = document.getElementsByClassName('formData').limite.value,
            ...
            razsoc = document.getElementsByClassName('formData').razsoc.value,
            image = document.getElementsByClassName('formData').image.value,
            idcob = document.getElementsByClassName('formData').idcob.value;        
            
            $.ajax({
                type: "POST",
                url: "{{ route('cadastros.cliente.insert') }}",
                data: {
                    _token:'{{csrf_token()}}',
                    bairro,
                    cidade,
        ...
        function pageRefresh(){
            window.location.href = "{{route('cadastros.cliente')}}";
        }

        function modalDados(id){
            $.ajax({
                url:"{{ route('cadastros.cliente.dados') }}",
                type:"post",
                datatype:"json",
                data:{
                    _token:"{{csrf_token()}}",
                ...
                success:function(retorno){
                    ...
                    document.getElementsByClassName('formDataVer').limiteVer.value        = 'R$ '+retorno[0].limite;          
                    ...
                    if(retorno[0].fnomecob == null){
                        document.getElementsByClassName('formDataVer').idcobVer.innerHTML = retorno[0].nomecob;         
                    }else{
                        document.getElementsByClassName('formDataVer').idcobVer.innerHTML = retorno[0].fnomecob;         
                    }
                    if(retorno[0].pessoa == 'F'){
                        document.getElementById('pessoaFVer').style = "display:;";
                        document.getElementById('pessoaJVer').style = "display:none;";
                        ...
                        document.getElementById('pessoaFVer').style = "display:none;";
                        document.getElementById('pessoaJVer').style = "display:;";
                        document.getElementsByClassName('formDataVer').fnomeVer.value         = retorno[0].fnome;         
                        document.getElementsByClassName('formDataVer').razsocVer.value        = retorno[0].razsoc;       
                        document.getElementsByClassName('formDataVer').cnpjVer.value          = retorno[0].cnpj;        
                    }
                    $('#modalVer').modal('show');
                },
            });
                ...
                $.ajax({
                    ...
                    success:function(retorno){
                        ...
                        if(retorno[0].pessoa == 'F'){
                            ...
                            dados[3].innerHTML = id;
                            dados[4].innerHTML = retorno[0].fnome;
                            dados[5].innerHTML = retorno[0].razsoc;
                            dados[6].innerHTML = retorno[0].cnpj;
                        }
        ...
        function modalEditar(id){
            ...
            $.ajax({
                ...
                success:function(retorno){
                    ...
                    elementos.limiteEdit.placeholder        = 'R$ '+retorno[0].limite;          
                    elementos.numeroEdit.placeholder        = retorno[0].numero;          
                    elementos.imageShowEdit.src        = '/images/'+retorno[0].image;          
                    if(retorno[0].fnomecob == null){
                        elementos.idcobEdit.innerHTML = retorno[0].nomecob;         
                    }else{
                        elementos.idcobEdit.innerHTML = retorno[0].fnomecob;         
                    }
                    if(retorno[0].pessoa == 'F'){
                        document.getElementById('pessoaFEdit').style = "display:;";
                        document.getElementById('pessoaJEdit').style = "display:none;";
                        elementos.nomeEdit.placeholder          = retorno[0].nome;        
                        elementos.cpfEdit.placeholder           = retorno[0].cpf;       
                    }else{
                        document.getElementById('pessoaFEdit').style = "display:none;";
                        document.getElementById('pessoaJEdit').style = "display:;";
                        elementos.fnomeEdit.placeholder         = retorno[0].fnome;         
                        elementos.razsocEdit.placeholder        = retorno[0].razsoc;       
                        elementos.cnpjEdit.placeholder          = retorno[0].cnpj;        
                    }
        ...
        function ModalConfAlter(){
            ...
            idcob = document.getElementsByClassName('formDataEditSelect').idcobEditSelect.value, 
            limite = document.getElementsByClassName('formDataEdit').limiteEdit.value,  
            nome = document.getElementsByClassName('formDataEdit').nomeEdit.value,
            razsoc = document.getElementsByClassName('formDataEdit').razsocEdit.value
            fnome = document.getElementsByClassName('formDataEdit').fnomeEdit.value,
            cpf = document.getElementsByClassName('formDataEdit').cpfEdit.value,                        
            cnpj = document.getElementsByClassName('formDataEdit').cnpjEdit.value,
