            ...
            <table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-block btn-outline-success btn-xs"><i class="fas fa-check-circle"></i> Elogio</button></td>
                    </tr>
                    <tr>
                        <td>345678</td>
                        <td>Joao Maria</td>
                    ...
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-block btn-secondary" data-toggle="modal" data-target="#modal-Ver"><i class="fas fa-eye"></i> Ver</button></td>
                        <td><button type="button" class="btn btn-block btn-outline-danger btn-xs"><i class="fas fa-times-circle"></i> Reclamação</button></td>
                    </tr>
                    <tr>
                        <td>345678</td>
                        <td>Maria Barbosa</td>
